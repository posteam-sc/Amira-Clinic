    ...
    public partial class ExpenseEntry : Form
    {
        ...
        private void ExpenseEntry_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (editExp != null)
                {
                    ...
                    txtBuyer.Text = editExp.Buyer.Trim();
                    txtPayeer.Text = editExp.Payeer.Trim();
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (expenseId != string.Empty)
            {
                ...
                exp.Buyer = txtBuyer.Text.Trim();
                exp.Payeer = txtPayeer.Text.Trim();
            ...
            else
            {
                ...
                if (expenseList.Count > 0)
                {
                    ...
                    expenseObj.Buyer = txtBuyer.Text.Trim();
                    expenseObj.Payeer = txtPayeer.Text.Trim();
