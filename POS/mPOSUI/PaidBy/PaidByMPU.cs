...
namespace POS
{
    public partial class PaidByMPU : Form
    {
        ...
        private void PaidByMPU_Load(object sender, EventArgs e)
        {
            ...
            System.Data.Objects.ObjectResult<String> Id = entity.InsertTransaction(DateTime.Now, MemberShip.UserId, MemberShip.CounterId, TransactionType.Sale, true, true, bankPaymentID, ExtraTax + Tax, ExtraDiscount + Discount, totalCost, totalCost, null, CustomerId, SalePerson,MCDiscount, BDDiscount, MemberTypeId, MCDiscountPercent, false, "", IsWholeSale, GiftDiscountAmt, SettingController.DefaultShop.Id, SettingController.DefaultShop.ShortCode, Note, tableId, servicefee, null);
