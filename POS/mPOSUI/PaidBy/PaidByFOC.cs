...
namespace POS
{
    public partial class PaidByFOC : Form
    {
        ...
        private void PaidByFOC_Load(object sender, EventArgs e)
        {
            ...
            System.Data.Objects.ObjectResult<String> Id = entity.InsertTransaction(DateTime.Now, MemberShip.UserId, MemberShip.CounterId, TransactionType.Sale, true, true, Type, ExtraTax + Tax, ExtraDiscount, totalCost, 0, null, CustomerId,SalePerson, MCDiscount, BDDiscount, MemberTypeId, MCDiscountPercent, false, "", IsWholeSale, 0, SettingController.DefaultShop.Id, SettingController.DefaultShop.ShortCode, Note, tableId, servicefee, null);
