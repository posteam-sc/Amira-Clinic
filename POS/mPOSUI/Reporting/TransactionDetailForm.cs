...
namespace POS
{
    public partial class TransactionDetailForm : Form
    {
        ...
        private void LoadData()
        {
            ...
            else if (transactionObject.Type == TransactionType.Sale || transactionObject.Type == TransactionType.GiftCard || transactionObject.Type == TransactionType.Credit)
            {
                ...
                if (transactionObject.Type != TransactionType.GiftCard)
                {
                    lblDiscount.Text = (transactionObject.DiscountAmount + transactionObject.GiftCardAmount).ToString();
                ...
                //   //GiftCard
                else if (transactionObject.Type == TransactionType.GiftCard)
                {
                    lblRecieveAmunt.Text = transactionObject.RecieveAmount.ToString();
