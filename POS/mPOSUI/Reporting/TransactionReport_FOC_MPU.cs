...
namespace POS
{
    public partial class TransactionReport_FOC_MPU : Form
    {
        ...
        private class TransactionReport
        {
                            ...
                            if (IsBank)
                            {
                                transList = (from t in entity.Transactions
                                             where EntityFunctions.TruncateTime((DateTime)t.DateTime) >= fromDate && EntityFunctions.TruncateTime((DateTime)t.DateTime) <= toDate && t.IsComplete == true && t.IsActive == true
                                                 ...
                                                 && ((IsCash && t.PaymentTypeId == 1) || (IsCredit && t.PaymentTypeId == 2) || (IsGiftCard && t.Type == TransactionType.GiftCard) || (IsFOC && t.PaymentTypeId == 4) ||
              ...
              (isBankTransfer && t.PaymentType.Name.Trim() == "Bank Transfer") || (IsCash && t.PaymentTypeId == 1) || (isMPU && t.PaymentType.Name.Trim() == "MPU") || (isJCB && t.PaymentType.Name.Trim() == "JCB")
                   ...
                   && (t.IsDeleted == null || t.IsDeleted == false) && ((shopid != 0 && t.Id.Substring(2, 2) == currentshortcode) || (shopid == 0 && 1 == 1))
                        ...
                        else if (IsSummary)
                        {
                            ...
                            GCtransList = (from t in entity.Transactions where EntityFunctions.TruncateTime((DateTime)t.DateTime) >= fromDate && EntityFunctions.TruncateTime((DateTime)t.DateTime) <= toDate && t.IsComplete == true && t.IsActive == true && t.Type == TransactionType.GiftCard && (t.PaymentTypeId == 1 || t.PaymentTypeId >= 501) && t.CounterId == CounterId && t.UserId == CashierId && (t.IsDeleted == null || t.IsDeleted == false) && ((shopid != 0 && t.Id.Substring(2, 2) == currentshortcode) || (shopid == 0 && 1 == 1)) select t).ToList<Transaction>();
                        ...
                        if (IsSale)
                        {
                            ...
                            else
                            {
                                transList = (from t in entity.Transactions
                                             where EntityFunctions.TruncateTime((DateTime)t.DateTime) >= fromDate && EntityFunctions.TruncateTime((DateTime)t.DateTime) <= toDate && t.IsComplete == true && t.IsActive == true
                                                 && (t.Type == TransactionType.Sale || t.Type == TransactionType.Credit) && t.UserId == CashierId
                                                 && ((IsCash && t.PaymentTypeId == 1) || (IsCredit && t.PaymentTypeId == 2) || (IsGiftCard && t.Type == TransactionType.GiftCard) || (IsFOC && t.PaymentTypeId == 4) || (IsTester && t.PaymentTypeId == 6)) &&
                                                 (t.IsDeleted == null || t.IsDeleted == false) && ((shopid != 0 && t.Id.Substring(2, 2) == currentshortcode) || (shopid == 0 && 1 == 1))
                                             orderby t.PaymentTypeId
                                             select t).ToList<Transaction>();
                            }
              ...
              (isBankTransfer && t.PaymentType.Name.Trim() == "Bank Transfer") || (IsCash && t.PaymentTypeId == 1) || (isMPU && t.PaymentType.Name.Trim() == "MPU") || (isJCB && t.PaymentType.Name.Trim() == "JCB")
                   ...
                   && (t.IsDeleted == null || t.IsDeleted == false) && ((shopid != 0 && t.Id.Substring(2, 2) == currentshortcode) || (shopid == 0 && 1 == 1))
                        ...
                        else if (IsSummary)
                        {
                            ...
                            GCtransList = (from t in entity.Transactions where EntityFunctions.TruncateTime((DateTime)t.DateTime) >= fromDate && EntityFunctions.TruncateTime((DateTime)t.DateTime) <= toDate && t.IsComplete == true && t.IsActive == true && t.Type == TransactionType.GiftCard && (t.PaymentTypeId == 1 || t.PaymentTypeId >= 501) && t.UserId == CashierId && (t.IsDeleted == null || t.IsDeleted == false) && ((shopid != 0 && t.Id.Substring(2, 2) == currentshortcode) || (shopid == 0 && 1 == 1)) select t).ToList<Transaction>();
              ...
              (isBankTransfer && t.PaymentType.Name.Trim() == "Bank Transfer") || (IsCash && t.PaymentTypeId == 1) || (isMPU && t.PaymentType.Name.Trim() == "MPU") || (isJCB && t.PaymentType.Name.Trim() == "JCB")
                   ...
                   && (t.IsDeleted == null || t.IsDeleted == false) && ((shopid != 0 && t.Id.Substring(2, 2) == currentshortcode) || (shopid == 0 && 1 == 1))
                        ...
                        else if (IsSummary)
                        {
                            ...
                            GCtransList = (from t in entity.Transactions where EntityFunctions.TruncateTime((DateTime)t.DateTime) >= fromDate && EntityFunctions.TruncateTime((DateTime)t.DateTime) <= toDate && t.IsComplete == true && t.IsActive == true && t.Type == TransactionType.GiftCard && (t.PaymentTypeId >= 501 || t.PaymentTypeId == 1) && t.CounterId == CounterId && (t.IsDeleted == null || t.IsDeleted == false) && ((shopid != 0 && t.Id.Substring(2, 2) == currentshortcode) || (shopid == 0 && 1 == 1)) select t).ToList<Transaction>();
                        ...
                        if (IsSale)
                        {
                            if (IsBank)
                            {
                                transList = (from t in entity.Transactions
                                             ...
                                             && (t.Type == TransactionType.Sale || t.Type == TransactionType.Credit || t.Type == TransactionType.GiftCard)
                                             && ((IsCash && t.PaymentTypeId == 1 && (t.Type == TransactionType.Sale)) ||
                                             (IsCredit && (t.Type == TransactionType.Credit))
                                             || (IsGiftCard && (t.Type == TransactionType.GiftCard))
                                             || (IsFOC && t.PaymentTypeId == 4) ||
                                              (isBankTransfer && t.PaymentType.Name.Trim() == "Bank Transfer") || (isMPU && t.PaymentType.Name.Trim() == "MPU") || (isJCB && t.PaymentType.Name.Trim() == "JCB")
                                                 || (isVisa && t.PaymentType.Name.Trim() == "Visa") || (isMaster && t.PaymentType.Name.Trim() == "Master") || (isUnionPay && t.PaymentType.Name.Trim() == "Union Pay")
                                                 || (isKBZPay && t.PaymentType.Name.Trim() == "KBZ Pay") || (isCBPay && t.PaymentType.Name.Trim() == "CB Pay") || (isAYAPay && t.PaymentType.Name.Trim() == "AYA Pay")
                                                 || (isWavePay && t.PaymentType.Name.Trim() == "Wave Pay") || (isOnePay && t.PaymentType.Name.Trim() == "One Pay") || (isSaiPay && t.PaymentType.Name.Trim() == "Sai Sai Pay")
                            ...
                            else
                            {
                                ...
                                transList = (from t in entity.Transactions
                                             ...
                                             && t.IsComplete == true && t.IsActive == true
                                             && (t.Type == TransactionType.Sale || t.Type == TransactionType.Credit || t.Type == TransactionType.GiftCard)
                                             && ((IsCash && t.PaymentTypeId == 1 && (t.Type == TransactionType.Sale)) || (IsCredit && (t.Type == TransactionType.Credit)) 
                                             || (IsFOC && t.PaymentTypeId == 4) 
                                             || (IsGiftCard && (t.Type == TransactionType.GiftCard)) || (IsTester && t.PaymentTypeId == 6)) &&
                                             (t.IsDeleted == null || t.IsDeleted == false) && ((shopid != 0 && t.Id.Substring(2, 2) == currentshortcode) || (shopid == 0 && 1 == 1))
                                             orderby t.Id
                                             select t).ToList<Transaction>();
                            }
              ...
              (isBankTransfer && t.PaymentType.Name.Trim() == "Bank Transfer") || (IsCash && t.PaymentTypeId == 1) || (isMPU && t.PaymentType.Name.Trim() == "MPU") || (isJCB && t.PaymentType.Name.Trim() == "JCB")
                   ...
                   && (t.IsDeleted == null || t.IsDeleted == false) && ((shopid != 0 && t.Id.Substring(2, 2) == currentshortcode) || (shopid == 0 && 1 == 1))
                        ...
                        else if (IsSummary)
                        {
                            ...
                            GCtransList = (from t in entity.Transactions where EntityFunctions.TruncateTime((DateTime)t.DateTime) >= fromDate && EntityFunctions.TruncateTime((DateTime)t.DateTime) <= toDate && t.IsComplete == true && t.IsActive == true && t.Type == TransactionType.GiftCard && (t.PaymentTypeId == 1 || t.PaymentTypeId >= 501) && (t.IsDeleted == null || t.IsDeleted == false) && ((shopid != 0 && t.Id.Substring(2, 2) == currentshortcode) || (shopid == 0 && 1 == 1)) select t).ToList<Transaction>();
        ...
        private void ShowReportViewer1()
        {
            ...
            dsReportTemp dsReport = new dsReportTemp();
            dsReportTemp.TransactionListDataTable dtTransactionReport = (dsReportTemp.TransactionListDataTable)dsReport.Tables["TransactionList"];
            List<TransactionReport> transactionReportList = new List<TransactionReport>();

            if (SettingController.IsSourcecode)
            {
                foreach (Transaction transaction in transList)
                {
                    var newRow = new TransactionReport();
                    newRow.TransactionId = transaction.Id;
                    newRow.Date = Convert.ToDateTime(transaction.DateTime);
                    newRow.SalePerson = entity.Customers.Where(x => x.Id == transaction.SalePerson).Select(x => x.Name).FirstOrDefault();
                    newRow.PatientName = transaction.Customer.Name;
                    newRow.PaymentMethod = transaction.PaymentType.Name;
                    newRow.Amount = Convert.ToInt32(transaction.TotalAmount);
                    newRow.DiscountAmount = (int)transaction.DiscountAmount;
                    newRow.Type = transaction.Type;
                    newRow.Qty = Convert.ToInt32(transaction.TransactionDetails.Where(x => x.IsDeleted == false).Sum(x => x.Qty));
                    ...
                    transactionReportList.Add(newRow);
                }
            }
            else
            {
                foreach (Transaction transaction in transList)
                {
                    ...
                    newRow.Type = transaction.Type;
                    newRow.Qty = Convert.ToInt32(transaction.TransactionDetails.Where(x => x.IsDeleted == false).Sum(x => x.Qty));
                    totalSale += Convert.ToInt32(transaction.RecieveAmount);
                    totalOtherFOC += Convert.ToInt32(transaction.TransactionDetails.Where(x => x.IsFOC == true).Sum((x => x.SellingPrice * x.Qty)));
                    transactionReportList.Add(newRow);
                }
            }
            ReportDataSource rds1 = new ReportDataSource();
            rds1.Name = "SaleDataSet";
            rds1.Value = transactionReportList;
            #endregion
            ...
            List<TransactionReport> RefundtransactionReportList = new List<TransactionReport>();
            foreach (Transaction transaction in RtransList)
            {
                ...
                RefundtransactionReportList.Add(newRow);
            }
            ReportDataSource rds2 = new ReportDataSource();
            rds2.Name = "RefundDataSet";
            rds2.Value = RefundtransactionReportList;
            totalRefundDiscount = RtransList.Sum(x => x.DiscountAmount).Value;
            #endregion

            #region Debt
            dsReportTemp dsReportDebt = new dsReportTemp();
            List<TransactionReport> DebttransactionReportList = new List<TransactionReport>();
            if (SettingController.IsSourcecode)
            {
                foreach (Transaction transaction in DtransList)
                {
                    ...
                    DebttransactionReportList.Add(newRow);
                }
            }
            else
            {
            ...
            rds3.Name = "DebtDataSet";
            rds3.Value = DebttransactionReportList;
            #endregion

            #region CreditRefund
            dsReportTemp dsReportCreditRefund = new dsReportTemp();
            List<TransactionReport> CreditRefundReportList = new List<TransactionReport>();
            foreach (Transaction transaction in CRtransList)
            {
                ...
                CreditRefundReportList.Add(newRow);
            }
            ReportDataSource rds4 = new ReportDataSource();
            rds4.Name = "CreditRefundDataSet";
            rds4.Value = CreditRefundReportList;
            ...
            List<TransactionReport> GiftCardReportList = new List<TransactionReport>();
            foreach (Transaction transaction in GCtransList)
            {
                ...
                GiftCardReportList.Add(newRow);
            }
            ReportDataSource rds5 = new ReportDataSource();
            rds5.Name = "GiftCardDataSet";
            rds5.Value = GiftCardReportList;
            #endregion

            #region Credit
            dsReportTemp dsReportCreditTransaction = new dsReportTemp();
            List<TransactionReport> CreditTransactionReportList = new List<TransactionReport>();
            if (SettingController.IsSourcecode)
            {
                foreach (Transaction transaction in CtransList)
                {
                    ...
                    CreditTransactionReportList.Add(newRow);
                }
            }
            else
            {
                ...
                rds6.Name = "CreditDataSet";
                rds6.Value = CreditTransactionReportList;
                #endregion

                #region MPU
                dsReportTemp dsReportMPUTransaction = new dsReportTemp();
                var MPUTransactionReportList = new List<TransactionReport>();
                foreach (Transaction transaction in MPUtransList)
                {
                    ...
                    MPUTransactionReportList.Add(newRow);
                }
                ReportDataSource rds7 = new ReportDataSource();
                rds7.Name = "MPUDataSet";
                rds7.Value = MPUTransactionReportList;
                #endregion

                #region FOC
                dsReportTemp dsReportFOCTransaction = new dsReportTemp();
                var FOCTransactionReportList = new List<TransactionReport>();
                foreach (Transaction transaction in FOCtrnsList)
                {
                    ...
                    FOCTransactionReportList.Add(newRow);
                }
                ReportDataSource rds8 = new ReportDataSource();
                rds8.Name = "FOCDataSet";
                rds8.Value = FOCTransactionReportList;
                #endregion

                #region Tester
                dsReportTemp dsReportTesterTransaction = new dsReportTemp();
                var TesterTransactionReportList = new List<TransactionReport>();
                foreach (Transaction transaction in TesterList)
                {
                    ...
                    TesterTransactionReportList.Add(newRow);
                }
                ReportDataSource rds9 = new ReportDataSource();
                rds9.Name = "TesterDataSet";
                rds9.Value = TesterTransactionReportList;
                #endregion
